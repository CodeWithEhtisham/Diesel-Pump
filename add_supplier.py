    ...
    def add_supplier(self):
        ...
        if not (name and phone and address and balance_type and balance):
            ...
            try:
                ...
                db.insert(table_name="supplier_cash_paid",columns="supplier_id,date,payment_method,cash_paid,remaining,description,quantity,rate,amount",values=f"'{db.cursor.lastrowid}', '{QDate.currentDate().toString('dd/MM/yyyy')}', 'Cash', '0', '{balance}', 'Opening Balance', '0', '0', '0'")
